...
const bmapTSConfigFilePath = nodePath.resolve(ecDir, 'extension-src/bmap/tsconfig.json');
...
module.exports = async function () {
    ...
    async function performCompileWork(
        ...
        await tsCompile(compilerOptionsOverride, tsConfigFilePath, srcPathList);
...
async function tsCompile(compilerOptionsOverride, tsConfigFilePath, srcPathList) {
